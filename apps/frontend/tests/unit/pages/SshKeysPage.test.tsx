...
describe('SshKeysPage', () => {
  ...
  it('add key form validates and submits', async () => {
    ...
    await user.type(keyInput, 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGo2v2d+lH2mR1mG5F/H5z6N8F4b5W5C9+0T0g/O+H/T')
    ...
    await waitFor(() => {
      expect(sshKeysApi.add).toHaveBeenCalledWith({
        label: 'New key',
        publicKey: 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIGo2v2d+lH2mR1mG5F/H5z6N8F4b5W5C9+0T0g/O+H/T'
      })
    })
  })
})
